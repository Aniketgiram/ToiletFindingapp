...
import com.example.thetoiletfindingapp.directionhelpers.FetchURLPrivate;
...
import com.example.thetoiletfindingapp.ui.PublicToilet.PublicToiletFragment;
...
public class PrivateToiletFragment extends Fragment implements OnMapReadyCallback, TaskLoadedCallback {

    private PrivateToiletViewModel privateToiletViewModel;
        ...
        public void onLocationResult(LocationResult locationResult) {
            ...
            if(locationResult == null){
                ...
                for(Location location:locationResult.getLocations()){
                    System.out.println("Location Hola "+location);
                    currentLocation = location;
                }
                SupportMapFragment mapFragment = (SupportMapFragment) getChildFragmentManager().findFragmentById(R.id.privateMap);
                mapFragment.getMapAsync(PrivateToiletFragment.this);
            }
        }
    };
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        privateToiletViewModel =
                ViewModelProviders.of(this).get(PrivateToiletViewModel.class);
        View view = inflater.inflate(R.layout.fragment_privatetoilet, container, false);
                ...
                if(title.equals("This is your Current Location")){
                   ...
                   myRef.child(marker.getTitle()).addListenerForSingleValueEvent(new ValueEventListener() {
                       ...
                       public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                           ...
                           DatabaseReference mref = database.getReference().child("toilets").child("private").child(marker.getTitle()).child("links");
...
//                        String url = getUrl(source.getPosition(),destination.getPosition(),"driving");
                           ...
                           new FetchURLPrivate(PrivateToiletFragment.this).execute(url,"driving");
...
//        double dist = distance(16.93064459,74.28587991,lat,lng);
